...
const Experience = () => {
  return (
    <div>
        ...
        <div className="mb-6">
            <h3 className="text-white font-semibold">... Intern | Indian Space Research Organization (ISRO)</h3>
        ...
        <div className="mb-6">
            <h3 className="text-white font-semibold">... Intern | Single Point Solutions Pvt. Ltd</h3>
