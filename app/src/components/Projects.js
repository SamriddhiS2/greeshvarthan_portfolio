...
export const projectsData = [
    ...
    { id: 'proj-2', title: 'Deep Analysis of Sound Pressure Level (SPL) in Aircraft', short: '...', long: 'Conducted a comprehensive study and analysis of the Sound Pressuer Levels (SPL) between Airbus A319 and Bombardier Dash 8 Q400; proposed a universal approach to enhanve passenger comfort during different flight regimes.', image: spl },
    ...
    { id: 'proj-4', title: 'CubeSat 2021 - LiFi in Space', short: '...', long: 'Presented the idea of LiFi communication inside a 1U satellite where preprogrammed data can be transferred between a transmitter and a receiver by means of Light fidelity.', image: cubesat },
];
