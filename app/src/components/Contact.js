...
const Contact = () => {
    return (
        <div>
            ...
            <A href="mailto:greeshv03@gmail.com" className="inline-block bg-teal-400/10 text-teal-300 px-4 py-2 rounded-md hover:bg-teal-400/20 transition-colors">INITIATE_EMAIL_TRANSMISSION</A>
